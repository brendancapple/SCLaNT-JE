...
geminiSentences = []
with open(PRIMARY_DIRECTORY + 'geminiData' + PARAMETER + '.csv', newline='', encoding="utf8") as csvFile:
  dialect = csv.Sniffer().sniff(csvFile.read(1024))
  csvFile.seek(0)
  reader = csv.reader(csvFile, dialect)
  for row in reader:
...
print("Read Successful: " + PRIMARY_DIRECTORY + 'geminiData' + PARAMETER + '.csv')
print(len(geminiSentences))
print("")

gptSentences = []
with open(PRIMARY_DIRECTORY + 'gptData' + PARAMETER + '.csv', newline='', encoding="utf8") as csvFile:
  dialect = csv.Sniffer().sniff(csvFile.read(1024))
  csvFile.seek(0)
  reader = csv.reader(csvFile, dialect)
  for row in reader:
...
print("Read Successful: " + PRIMARY_DIRECTORY + 'gptData' + PARAMETER + '.csv')
...
resultsData = []
with open(PRIMARY_DIRECTORY + 'resultsData' + PARAMETER + '.csv', newline='', encoding="utf8") as csvFile:
  dialect = csv.Sniffer().sniff(csvFile.read(1024))
  csvFile.seek(0)
  reader = csv.reader(csvFile, dialect)
  for row in reader:
    resultsData.append(row)
print("Read Successful: " + PRIMARY_DIRECTORY + 'resultsData' + PARAMETER + '.csv')
...
with open(PRIMARY_DIRECTORY + 'resultsData' + PARAMETER + '.csv', 'w', newline='', encoding="utf8") as f:
  writer = csv.writer(f)
  writer.writerows(resultsData)
  print("Write Successful: " + PRIMARY_DIRECTORY + 'resultsData' + PARAMETER + '.csv')
